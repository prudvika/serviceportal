...
<html lang="en">
  ...
  <body>
	...
	<section id="list">
		...
		<div class="mode-toolbar">
         ...
         <button id="platform" class="green"
           ...
           <button id="dashboard_settings" class="green" onclick="location='<c:url value="/dashboardmanager/settings?type=Test" />'">Dashboard Settings</button>
           <button id="settings" class="green" onclick="location='dmsettings.jsp'">Settings</button>
         </div>
       </div>
    ...
    <details open>
	    <summary><c:out value="${fn:length(dashboardList)}" /> Dashboards</summary>
    ...
    <table border="1">
      ...
      <c:forEach items="${dashboardList}" var="dashboard">
        <tr>
          <td align="left"><a href="<c:url value="/dashboardmanager/dashboardeditor?name=${dashboard.name}" />"><c:out value="${dashboard.name}" /></a></td>
